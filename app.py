...
app.layout = html.Div(children=[
    ...
    html.H1("1- Stations with the biggest traffic", style={'background-color': '#4169E1', 'color':'white',
                                                           'text-align':'center'}),
    ...
    html.H1("2- Number of stations per exploitant and per line", style={'background-color': '#4169E1', 'color':'white',
                                                                      'text-align':'center'}),
    ...
    html.H1("4- Interactive map", style={'background-color': '#4169E1', 'color':'white',
                                         'text-align':'center'}),
